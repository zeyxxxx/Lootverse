...
<nav class="navbar">
    ...
    <div class="search-wrapper" style="position: relative; width: 550px; max-width: 100%; display: flex; align-items: center; justify-content: center;">
        <div class="search-container" style="width: 100%;">
            <form action="${pageContext.request.contextPath}/catalogo" method="GET" style="margin: 0; padding: 0; display: flex; width: 100%;">
                <input type="text" id="searchInput" name="searchQuery" placeholder="Cerca prodotti..." autocomplete="off" value="${searchQuery}">
            </form>
        </div>
        ...
        <c:choose>
            ...
            <c:when test="${not empty sessionScope.utenteLoggato}">
                <li><a href="${pageContext.request.contextPath}/carrello" class="cart-icon-container"> 
                    ...
                    <c:if test="${not empty sessionScope.cartBadgeCount and sessionScope.cartBadgeCount > 0}">
